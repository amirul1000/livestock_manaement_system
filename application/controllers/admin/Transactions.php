...
'refference' => html_escape($this->input->post('refference')),
...
$this->db->or_like('refference', $key, 'both');
...
$this->db->or_like('updated_at', $key, 'both');
	...
	function export($export_type='CSV'){
	  if($export_type=='CSV'){	
		   ...
		   $header = array("Id","Animal Id","Subject","Description","Debit","Credit","Refference","Created At","Updated At"); 
		   fputcsv($file, $header);
